...
JOBS=(
  ...
  # Its daily half (Kevin, 25 Sep 2026). A script, not a slot: approved payment
  # cards onto the list, paid rows off it, and the transfers nothing listed.
  "payment-run-daily|6:30|/usr/bin/python3 $REPO/scripts/payment-run.py daily"
