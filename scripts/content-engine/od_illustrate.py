...
STYLE = ("Clean, modern LinkedIn infographic in flat vector illustration style, the kind top business creators post: generous white space, one bold "
         ...
         "markers, a subtle grid. Portrait 4:5. Typeface: a clean geometric sans-serif. " + PALETTE + ". Footer, small, bottom left, the two words Operations Director with no quotation marks around them. No person's name anywhere on the picture, no signature, no headshot: generic and universal. Leave the bottom-right corner as plain background with nothing drawn in it: no box, no panel, no shape, no marker; the logo is added afterwards by code. No stray numbered markers or step badges anywhere except where the layout below asks for numbers. "
