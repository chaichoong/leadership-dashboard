...
(function () {
  ...
  function overlay() {
    ...
    d.innerHTML =
      ...
      '<div style="font-size:18px;font-weight:700;color:#1C2422">Operations — Supabase</div>' +
      '<div style="font-size:13px;color:#5A6660;margin:2px 0 16px">Sign in to load property &amp; tenancy data</div>' +
  ...
  async function start() {
    ...
    async function attempt() {
      ...
      const { error } = await window.sbOpsSignIn(email, pass);
