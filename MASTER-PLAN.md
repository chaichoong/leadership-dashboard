...
- [ ] ERICAMAE — (NEW 13 Jul) Nurture sequence triggers on GHL tag `od-prospect-nurture`; templates carry sender identity, postal address and unsubscribe (PECR) with Kevin sign-off before switch-on (done when: test Ltd contact tagged receives the sequence; due 18 Jul) [AT:-]
