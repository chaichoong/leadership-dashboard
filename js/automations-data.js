...
var AUTOMATIONS = {
    ...
    macJobs: [
        ...
        { key: 'tenant-leads', name: 'Tenant-finding chain', when: '8:10am daily', status: 'on',
          what: 'Finds rooms that need a tenant (a void, a notice, or a room move adopted on the Growth Plan) and keeps single people aged 35 or over on Universal Credit coming in. It drafts one email card for your queue to the council, charity and support contacts near the room, one to our tenants about the £50 referral bonus, and a monthly check-in to people on the list. It gives Roy the adverts to post and a list of qualified people to call for viewings. It screens every sign-up from the form, and puts a £50 bonus on the Friday Payment Run when a referred tenant pays their first rent. It writes the Tenant-finding chain line on the Estate status board, which turns red when a step that should have happened did not.' },
