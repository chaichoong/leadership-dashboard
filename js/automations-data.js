...
var AUTOMATIONS = {
    ...
    macJobs: [
        ...
        { key: 'content-engine', name: 'Content Engine folder watch', when: '2:00am daily', status: 'on',
          what: 'Looks in the Runpreneur raw video folder on Drive for clips it has not seen, creates one "Episode N Full Episode" record per new shooting day (New Upload) and copies the oldest waiting clip to this Mac, then turns one pulled clip into the three Runpreneur videos (full 16:9 with captions, LFMD and Summary 9:16 with the banner), files them in the edited Drive folder and writes the links and transcript onto the episode record. Never publishes.' },
