...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        { id: 'overview',    name: 'Leadership Dashboard',           icon: '📊', pageVer: '2.107', sopFile: 'sop.html',                   sopVer: '2.94', standalone: 'index.html#overview' },
        ...
        { id: 'tasks',       name: 'Tasks & Projects',   icon: '✅', pageVer: '1.173', sopFile: 'os/tasks/sop.html',             sopVer: '1.4', standalone: 'os/tasks/index.html' },
        ...
        { id: 'growth-plan', name: 'Growth Plan',                    icon: '📈', pageVer: '1.51', sopFile: 'sop-growth-plan.html',        sopVer: '1.5', standalone: 'growth-plan.html' },
        ...
        { id: 'agents', name: 'AI Agents', icon: '🤖', pageVer: '1.97', sopFile: 'sop-ai-agents.html', sopVer: '1.42', standalone: 'os/agents/index.html', adminOnly: true },
        { id: 'fintable',  name: 'Accounts',                       icon: '🏦', pageVer: '1.19', sopFile: '',                            sopVer: '1.0', standalone: 'index.html#fintable' },
        { id: 'systemisation', name: 'Systemisation',              icon: '⚙️', pageVer: '1.20', sopFile: 'guides/systemisation.html',    sopVer: '1.11', standalone: 'os/systemisation/index.html' },
        ...
        { id: 'skills',     name: 'Skills Library',                icon: '🧠', pageVer: '1.24', sopFile: 'guides/skills.html',           sopVer: '1.0', standalone: 'index.html#skills' },
