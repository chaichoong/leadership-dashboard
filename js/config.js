...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        ...
        { id: 'tasks',       name: 'Task and Project Management',   icon: '✅', pageVer: '1.50', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        { id: 'cfv',        name: 'CFVs',                          icon: '🚨', pageVer: '1.11', sopFile: 'sop-cfvs.html',               sopVer: '1.6', standalone: 'index.html#cfv' },
        { id: 'costs',      name: 'Accounts Payable Fixed',        icon: '📋', pageVer: '1.2', sopFile: '',                            sopVer: '1.0', standalone: 'index.html#costs' },
        ...
        { id: 'comms',      name: 'Inbound Comms',                 icon: '📨', pageVer: '2.21', sopFile: 'inbound-comms-sop.html',      sopVer: '2.3', standalone: 'follow-up.html' },
        ...
        { id: 'operations',  name: 'Operations',                    icon: '🏢', pageVer: '1.8', sopFile: '',                            sopVer: '1.0', standalone: 'os/operations/index.html' },
        ...
        { id: 'os-bplan',  name: 'Business Launch Plan Builder',   icon: '📋', pageVer: '1.7', sopFile: 'os/business-plan-builder/sop.html', sopVer: '1.3', standalone: 'os/business-plan-builder/index.html' },
