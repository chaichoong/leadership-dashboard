...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        { id: 'overview',    name: 'Leadership Dashboard',           icon: '📊', pageVer: '2.29', sopFile: 'sop.html',                   sopVer: '2.9', standalone: 'index.html#overview' },
        ...
        { id: 'tasks',       name: 'Tasks & Projects',   icon: '✅', pageVer: '1.77', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        { id: 'cfv',        name: 'CFVs',                          icon: '🚨', pageVer: '1.21', sopFile: 'sop-cfvs.html',               sopVer: '1.6', standalone: 'index.html#cfv' },
        ...
        { id: 'costs',      name: 'Accounts Payable Fixed',        icon: '📋', pageVer: '1.6', sopFile: '',                            sopVer: '1.0', standalone: 'index.html#costs' },
        ...
        { id: 'pnl',        name: 'Profit & Loss',                 icon: '💰', pageVer: '2.20', sopFile: 'sop-pnl.html',               sopVer: '2.12', standalone: 'index.html#pnl' },
        { id: 'transactions', name: 'Transactions',                icon: '🔍', pageVer: '1.0', sopFile: '',                            sopVer: '1.0', standalone: 'index.html#transactions' },
        { id: 'comms',      name: 'Inbound Comms',                 icon: '📨', pageVer: '2.45', sopFile: 'inbound-comms-sop.html',      sopVer: '2.4', standalone: 'follow-up.html' },
        ...
        { id: 'operations',  name: 'Operations',                    icon: '🏢', pageVer: '1.31', sopFile: '',                            sopVer: '1.0', standalone: 'os/operations/index.html' },
