...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        ...
        { id: 'os-strategy', name: 'Objective & Strategy OS',         icon: '🎯', pageVer: '1.3', sopFile: 'os/strategy/sop.html',       sopVer: '1.0', standalone: 'os/strategy/index.html' },
        { id: 'tasks',       name: 'Task and Project Management OS', icon: '✅', pageVer: '1.38', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        ...
        { id: 'pnl',        name: 'Profit & Loss',                 icon: '💰', pageVer: '2.13', sopFile: 'sop-pnl.html',               sopVer: '2.12', standalone: 'index.html#pnl' },
        ...
        { id: 'operations',  name: 'Operations OS',                 icon: '🏢', pageVer: '1.2', sopFile: '',                            sopVer: '1.0', standalone: 'os/operations/index.html' },
