...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        { id: 'overview',    name: 'Leadership Dashboard',           icon: '📊', pageVer: '2.99', sopFile: 'sop.html',                   sopVer: '2.94', standalone: 'index.html#overview' },
        ...
        { id: 'tasks',       name: 'Tasks & Projects',   icon: '✅', pageVer: '1.166', sopFile: 'os/tasks/sop.html',             sopVer: '1.4', standalone: 'os/tasks/index.html' },
        ...
        { id: 'agents', name: 'AI Agents', icon: '🤖', pageVer: '1.59', sopFile: 'sop-ai-agents.html', sopVer: '1.42', standalone: 'os/agents/index.html', adminOnly: true },
