...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        { id: 'overview',    name: 'Leadership Dashboard',           icon: '📊', pageVer: '2.26', sopFile: 'sop.html',                   sopVer: '2.9', standalone: 'index.html#overview' },
        ...
        { id: 'tasks',       name: 'Task and Project Management',   icon: '✅', pageVer: '1.65', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        { id: 'cfv',        name: 'CFVs',                          icon: '🚨', pageVer: '1.18', sopFile: 'sop-cfvs.html',               sopVer: '1.6', standalone: 'index.html#cfv' },
        ...
        { id: 'comms',      name: 'Inbound Comms',                 icon: '📨', pageVer: '2.34', sopFile: 'inbound-comms-sop.html',      sopVer: '2.4', standalone: 'follow-up.html' },
        ...
        { id: 'operations',  name: 'Operations',                    icon: '🏢', pageVer: '1.14', sopFile: '',                            sopVer: '1.0', standalone: 'os/operations/index.html' },
        ...
        { id: 'skills',     name: 'Skills Library',                icon: '🧠', pageVer: '1.1', sopFile: '',                             sopVer: '1.0', standalone: 'index.html#skills' },
    ];
