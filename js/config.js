...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        ...
        { id: 'tasks',       name: 'Task and Project Management OS', icon: '✅', pageVer: '1.4', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        ...
        { id: 'sitemap',    name: 'Site Map & Links',              icon: '🔗', pageVer: '1.5', sopFile: 'sop-sitemap.html',            sopVer: '1.1', standalone: 'index.html#sitemap' },
    ];
