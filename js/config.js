...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        ...
        { id: 'os-strategy', name: 'Objective & Strategy',           icon: '🎯', pageVer: '1.8', sopFile: 'os/strategy/sop.html',       sopVer: '1.0', standalone: 'os/strategy/index.html' },
        { id: 'tasks',       name: 'Task and Project Management',   icon: '✅', pageVer: '1.53', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        { id: 'cfv',        name: 'CFVs',                          icon: '🚨', pageVer: '1.12', sopFile: 'sop-cfvs.html',               sopVer: '1.6', standalone: 'index.html#cfv' },
        { id: 'costs',      name: 'Accounts Payable Fixed',        icon: '📋', pageVer: '1.3', sopFile: '',                            sopVer: '1.0', standalone: 'index.html#costs' },
        ...
        { id: 'comms',      name: 'Inbound Comms',                 icon: '📨', pageVer: '2.23', sopFile: 'inbound-comms-sop.html',      sopVer: '2.3', standalone: 'follow-up.html' },
        { id: 'compliance', name: 'Property Compliance',            icon: '✅', pageVer: '1.7', sopFile: 'sop-compliance.html',         sopVer: '1.1', standalone: 'compliance.html' },
        { id: 'operations',  name: 'Operations',                    icon: '🏢', pageVer: '1.9', sopFile: '',                            sopVer: '1.0', standalone: 'os/operations/index.html' },
        ...
        { id: 'os-bplan',  name: 'Business Launch Plan Builder',   icon: '📋', pageVer: '1.8', sopFile: 'os/business-plan-builder/sop.html', sopVer: '1.3', standalone: 'os/business-plan-builder/index.html' },
