...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        { id: 'overview',    name: 'Leadership Dashboard',           icon: '📊', pageVer: '2.43', sopFile: 'sop.html',                   sopVer: '2.9', standalone: 'index.html#overview' },
        { id: 'os-strategy', name: 'Objective & Strategy',           icon: '🎯', pageVer: '1.16', sopFile: 'os/strategy/sop.html',       sopVer: '1.0', standalone: 'os/strategy/index.html' },
        { id: 'tasks',       name: 'Tasks & Projects',   icon: '✅', pageVer: '1.112', sopFile: 'os/tasks/sop.html',             sopVer: '1.1', standalone: 'os/tasks/index.html' },
        ...
        { id: 'comms',      name: 'Inbound Comms',                 icon: '📨', pageVer: '2.53', sopFile: 'inbound-comms-sop.html',      sopVer: '2.4', standalone: 'follow-up.html' },
        ...
        { id: 'operations',  name: 'Operations',                    icon: '🏢', pageVer: '1.43', sopFile: '',                            sopVer: '1.0', standalone: 'os/operations/index.html' },
        ...
        { id: 'os-bplan',  name: 'Business Launch Plan Builder',   icon: '📋', pageVer: '1.15', sopFile: 'os/business-plan-builder/sop.html', sopVer: '1.3', standalone: 'os/business-plan-builder/index.html' },
        { id: 'fintable',  name: 'Accounts',                       icon: '🏦', pageVer: '1.8', sopFile: '',                            sopVer: '1.0', standalone: 'index.html#fintable' },
        { id: 'systemisation', name: 'Systemisation',              icon: '⚙️', pageVer: '1.6', sopFile: '',                            sopVer: '1.0', standalone: 'os/systemisation/index.html' },
        { id: 'os-team',    name: 'Team Members',                  icon: '👥', pageVer: '1.3', sopFile: '',                            sopVer: '1.0', standalone: 'os/team/index.html' },
        { id: 'crm',        name: 'CRM',                           icon: '👥', pageVer: '1.0', sopFile: 'crm-guide.html',              sopVer: '1.0', standalone: 'crm-supabase.html' },
