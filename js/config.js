...
// ══════════════════════════════════════════
    ...
    const PAGE_REGISTRY = [
        { id: 'overview',    name: 'Leadership Dashboard',           icon: '📊', pageVer: '2.90', sopFile: 'sop.html',                   sopVer: '2.9', standalone: 'index.html#overview' },
        ...
        { id: 'tasks',       name: 'Tasks & Projects',   icon: '✅', pageVer: '1.155', sopFile: 'os/tasks/sop.html',             sopVer: '1.4', standalone: 'os/tasks/index.html' },
        ...
        { id: 'agents', name: 'AI Agents', icon: '🤖', pageVer: '1.42', sopFile: 'sop-ai-agents.html', sopVer: '1.42', standalone: 'os/agents/index.html', adminOnly: true },
        ...
        { id: 'os-team',    name: 'Team Members',                  icon: '👥', pageVer: '1.24', sopFile: '',                            sopVer: '1.1', standalone: 'os/team/index.html' },
        ...
        { id: 'prospecting', name: 'Prospecting',                   icon: '🧲', pageVer: '1.17', sopFile: 'sop-prospecting.html',        sopVer: '1.5', standalone: 'index.html#prospecting' },
