...
const KPI_LIBRARY = [
    ...
    { tier: 1, group: 'Work', name: 'AI hours + labour cost saved', shape: 'T5', status: 'live',
      how: 'The money view of the same engine as Work done by AI %: AI minutes on completed tasks (identical counting rules — Team Member agent OR approved first time, never sent-back work) × a fully-loaded hourly wage rate, shown as a rolling 30 days and a since-AI-go-live total plus a full-time-equivalent framing. The rate and the go-live date are constants today (Kevin: £17.50/hr, 1 Jun 2026) and become per-tenant settings — every client has their own wage cost and their own start date. Whole pounds only; pence on an estimate is false precision.' },
