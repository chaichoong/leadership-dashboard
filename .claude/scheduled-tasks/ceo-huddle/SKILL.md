---
name: ceo-huddle
description: Run the CEO's daily huddle with the heads of department at 05:00 on weekdays, four hours ahead of the 09:00 Slack brief, and write the digest into today's CEO Briefs record so the brief carries it
---
...
```
python3 /Users/kevinbrittain/Projects/leadership-dashboard/scripts/job-queue.py acquire ceo-huddle --lease 60
```
...
```
python3 /Users/kevinbrittain/Projects/leadership-dashboard/scripts/job-queue.py release ceo-huddle
```

If your run will take longer than 60 minutes, extend the lease as you go:
`python3 /Users/kevinbrittain/Projects/leadership-dashboard/scripts/job-queue.py heartbeat ceo-huddle --lease 60`.
