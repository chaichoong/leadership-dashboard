...
description: Verify the 9am CEO brief fired; diagnose from worker logs and fix or send manually if it did not
---
...
```
python3 /Users/kevinbrittain/Projects/leadership-dashboard/scripts/job-queue.py acquire ceo-brief-morning-check --lease 45
```
...
```
python3 /Users/kevinbrittain/Projects/leadership-dashboard/scripts/job-queue.py release ceo-brief-morning-check
```

If your run will take longer than 45 minutes, extend the lease as you go:
`python3 /Users/kevinbrittain/Projects/leadership-dashboard/scripts/job-queue.py heartbeat ceo-brief-morning-check --lease 45`.
